...
const UpdateProduct = () => {
  ...
  const deleteProduct = async () => {
    try {
      const res = await axios.delete(
        `https://medicart-backend.onrender.com/ecomm/api/v1/auth/deleteProduct/${id}`
      );
      if (res.data.success) {
  ...
  const updateProduct = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(`https://medicart-backend.onrender.com/ecomm/api/v1/auth/updateProduct/${id}`,productData);
      if(res.data.success)
      {
        toast.success(res.data.message,{
          duration: 5000,
        ...
        <div className="w-full">
          ...
          <div className="main lg:mt-20 lg:flex">
            <div className="logo lg:w-1/2 border-r-2 border-black">
              <img src={`https://medicart-backend.onrender.com/ecomm/api/v1/auth/productPhoto/${id}`} alt="Logo" className=" h-full" />
            </div>
