  ...
  const getOrder = async () => {
    try {
      const res = await axios.get(
        `https://medicart-backend.onrender.com/ecomm/api/v1/auth/orderDetail/${auth.user.email}`
      );
                      ...
                      >
                        <td className="flex justify-center items-center px-6 py-3 text-center border-2">
                          <img
                            ...
                            src={`https://medicart-backend.onrender.com/ecomm/api/v1/auth/productPhoto/${item.productId._id}`}
                          ></img>
                        </td>
