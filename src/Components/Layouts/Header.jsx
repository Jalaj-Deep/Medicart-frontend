    ...
    >
      <ul className="md:p-0 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 border-grey-700 flex flex-col p-4 mt-4 font-medium border rounded-lg">
        <li>
          <NavLink
            to="/"
            className="md:border-0 md:p-0 text-white hover:text-blue-500 hover:bg-blue-700 rounded px-3 py-2 block"
            aria-current="page"
          >
            Home
          </NavLink>
        ...
        {!auth.user ? (
          <>
            <li>
              <NavLink
                to="/log-in"
                className="md:border-0 md:p-0 text-white md:hover:text-blue-500 hover:bg-blue-700 hover:text-white md:hover:bg-transparent block px-3 py-2 rounded"
              >
